...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-21 14:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c6f17235-91ff-4b3e-be92-fd438c235a26.git
$ cd c6f17235-91ff-4b3e-be92-fd438c235a26
```
